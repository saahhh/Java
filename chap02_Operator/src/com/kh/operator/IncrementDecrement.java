...
public class IncrementDecrement {
	...
	public static void main(String[] args) {
		...
		/* 증감연산자는 변수의 값을 1씩 증가시키거나 감소시킬 때 사용한다.
	  	   전위 증감 연산자(++x(x는숫자), --x) 후위 증감 연산자(x++, x--)
			1-1) 전위 증감 연산자
			++ 항의 값에 1을 더한다.
		 ...
		 * */
		int val1, val2; // val은 값이 없음
		int num1 = 10;
		val1 = ++num1; // num의 값이 1 증가한 후 val 변수에 대입하기 때문에 11이 대입됨
		System.out.println(val1);
		
	
		val2 = --num1;
		//num의 값이 1 감소한 후에 val 변수에 대입
		...
		val3 = num2++; //val3 변수에 기존 num3 값을 대입한 후에 num3 값이 1 증가
		//1번 val3 = num2 값 추가하자
